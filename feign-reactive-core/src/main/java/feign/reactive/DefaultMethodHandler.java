...
final class DefaultMethodHandler implements MethodHandler {
	...
	/**
	 * Bind this handler to a proxy object. After bound, DefaultMethodHandler#invoke will
	 * act as if it was called on the proxy object. Must be called once and only once for
	 * a given instance of DefaultMethodHandler
	 */
