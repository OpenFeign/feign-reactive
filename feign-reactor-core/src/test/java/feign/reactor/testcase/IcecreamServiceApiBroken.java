 ...
 * the License.
 */
package feign.reactor.testcase;

import feign.Headers;
import feign.Param;
import feign.RequestLine;
import feign.reactor.ReactiveDelegatingContract;
import feign.reactor.testcase.domain.Bill;
import feign.reactor.testcase.domain.Flavor;
import feign.reactor.testcase.domain.IceCreamOrder;
import feign.reactor.testcase.domain.Mixin;
